...
final class HorizonScanner {
    ...
    func scan(features: [HorizonFeature], at location: CLLocationCoordinate2D, bearing: CLLocationDirection) -> ScanResult {
        ...
        for (id, feature) in self.activeFeatures {
            ...
            if self.isFeaturePassed(feature, userPosition: userPosition, featurePosition: featurePosition, distance: distance) {
        ...
        for feature in features {
            ...
            if withinAlertDistance {
                ...
                let featureDistance = FeatureDistance(feature: feature, distance: measurement)
        ...
        return ScanResult(detectedFeatures: detectedFeatures, approachingFeatures: approachingFeatures, exitedFeatures: exitedFeatures)
    }
}

private extension HorizonScanner {

    func isFeaturePassed(_: HorizonFeature, userPosition: RoutePosition, featurePosition: RoutePosition, distance: CLLocationDistance) -> Bool {
    ...
    func calculateRouteDistance(from: CLLocationCoordinate2D, to: CLLocationCoordinate2D, featureId: String) -> CLLocationDistance {
    ...
    func isFeatureRelevant(_ feature: HorizonFeature, userLocation: CLLocationCoordinate2D, userBearing: CLLocationDirection) -> FeatureRelevance {
        switch feature.type {
