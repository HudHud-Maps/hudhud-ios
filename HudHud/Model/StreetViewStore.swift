...
final class StreetViewStore {
    ...
    var streetViewClient = StreetViewClient(transport: transport)
    ...
    init(streetViewScene: StreetViewScene? = nil, nearestStreetViewScene: StreetViewScene? = nil, fullScreenStreetView: Bool = false, mapStore: MapStore, streetViewClient: StreetViewClient = StreetViewClient(transport: transport), cachedScenes: [Int: StreetViewScene] = [Int: StreetViewScene]()) {
