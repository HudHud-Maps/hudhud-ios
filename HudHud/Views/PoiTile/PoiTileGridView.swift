...
struct PoiTileGridView: View {
	...
	var body: some View {
		ScrollView {
			LazyVGrid(columns: self.columns, alignment: .center, spacing: 20) {
...
#Preview {
	...
	let poi1 = PoiTileData(title: "Off white",
						   ...
						   isFollowed: true,
						   pricing: .high)
	let poi2 = PoiTileData(title: "Red Sea",
						   imageUrl: URL(string: "https://img.freepik.com/free-photo/meat-burger-wooden-board-french-fries-side-view_141793-2388.jpg?t=st=1708506403~exp=1708507003~hmac=c82d36abb17b2ae727770a011ab20c5d07aeb6f9ce6f0488be6bbd762838c8be"),
						   poiType: "Shop",
						   locationDistance: pointA.distance(from: pointB),
						   rating: "3.5",
