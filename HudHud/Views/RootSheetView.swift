...
//                        searchStore: self.searchViewStore, trendingStore: self.trendingStore, sheetStore: self.sheetStore, mySheet: SheetStore(emptySheetType: .search), filterStore: self.searchViewStore.filterStore)
...
//                            sheetStore: self.sheetStore, mySheet: SheetStore(emptySheetType: .search),
//                            filterStore: self.searchViewStore.filterStore
//                        )
//                        .navigationBarBackButtonHidden()
//                    case .favorites:
...
//                            searchStore: freshSearchViewStore,
//                            trendingStore: self.trendingStore,
//                            sheetStore: SheetStore(), mySheet: SheetStore(emptySheetType: .search),
//                            filterStore: self.searchViewStore.filterStore
//                        )
