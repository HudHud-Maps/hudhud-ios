...
final class LocationEngineTests: XCTestCase {
    ...
    func test_passThroughManager_delegateNotification() {
        ...
        XCTAssertEqual(delegate.receivedLocations?.first?.coordinate.latitude,
                       location.coordinates.lat)
        XCTAssertEqual(delegate.receivedLocations?.first?.coordinate.longitude,
...
private extension LocationEngineTests {
    ...
    func assertModeChange(to expectedMode: LocationMode,
    ...
    func assertProviderChange(to expectedType: LocationProviderType,
                              file: StaticString = #file,
                              line: UInt = #line,
                              action: () -> Void) {
        self.assertPublishedEvent(description: "Provider changed event",
    ...
    func makeUserLocation(lat: Double = 37.7749,
        ...
        UserLocation(coordinates: GeographicCoordinate(lat: lat, lng: lng),
...
extension Route {
    static func stub() -> Route {
        ...
        bbox: BoundingBox(sw: GeographicCoordinate(lat: 37.7739, lng: -122.4312),
